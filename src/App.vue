  ...
  <div id="app">
    ...
    filename: 'document'
        ...
        <div data-pdf-page class="pdf-page page-7">
          ...
          <h3>繁体字与异体字</h3>
          <p>
            鬱鬱蔥蔥讀書萬卷習慣處處皆學問機會難得寶貴時間飛逝歲月崢嶸歷練艱辛驚豔奪目燦爛輝煌璀璨奪目瑰麗壯觀險峻陡峭嶄新嶙峋峻峭巍峨巒峰疊嶂
          </p>
          ...
          <h3>地名与专有名词</h3>
          <p>
            鄭州鞏義滎陽汴梁洛邑豫州冀州兗州徐州揚州荊州梁州雍州涼州幽州幷州崑崙巫峽瞿塘灩澦嘉陵岷江峨眉劍閣潼關函谷蒲坂渭南咸陽長樂未央建章
          </p>
        ...
        <div data-pdf-page class="pdf-page page-7">
          <h3>诗词常见字</h3>
          <p>
            蕭瑟霜露淒清嘯風嘆瀟灑飄零悵惘惆悵徘徊躊躇彷徨躑躅蹉跎嗟歎淚痕憔悴憂愁哀怨愁緒閒愁幽怨淒涼淒婉婉轉悠揚嘹亮嫋嫋裊裊嫋娜娉婷婀娜綽約
          </p>

          <h3>成语典故用字</h3>
          <p>
            鞠躬盡瘁死而後已臥薪嘗膽懸梁刺股鑿壁偷光囊螢映雪韋編三絕孜孜不倦錙銖必較殫精竭慮嘔心瀝血披荊斬棘櫛風沐雨篳路藍縷胼手胝足櫛沐風雨
          </p>

          <h3>文化与哲学用语</h3>
          <p>
            陰陽五行乾坤坎離震巽艮兌八卦六十四卦太極兩儀四象河圖洛書周易繫辭天干地支甲乙丙丁戊己庚辛壬癸子丑寅卯辰巳午未申酉戌亥歲次紀年曆法
          </p>
